...
set(MSG_I_FLAGS "-Irosbot_ekf:/home/husarion/husarion_workspace/src/rosbot_ekf/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/husarion/husarion_workspace/src/rosbot_ekf/srv/Configuration.srv" NAME_WE)
add_custom_target(_rosbot_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosbot_ekf" "/home/husarion/husarion_workspace/src/rosbot_ekf/srv/Configuration.srv" ""
)

get_filename_component(_filename "/home/husarion/husarion_workspace/src/rosbot_ekf/msg/Imu.msg" NAME_WE)
add_custom_target(_rosbot_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosbot_ekf" "/home/husarion/husarion_workspace/src/rosbot_ekf/msg/Imu.msg" "geometry_msgs/Quaternion:std_msgs/Header"
)
...
_generate_msg_cpp(rosbot_ekf
  "/home/husarion/husarion_workspace/src/rosbot_ekf/msg/Imu.msg"
  "${MSG_I_FLAGS}"
...
_generate_srv_cpp(rosbot_ekf
  "/home/husarion/husarion_workspace/src/rosbot_ekf/srv/Configuration.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rosbot_ekf
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosbot_ekf)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosbot_ekf\")")
  # install generated code
  install(
